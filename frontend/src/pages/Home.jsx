...
function Home() {
    ...
    const features = [
        {
            ...
            description: 'AI-powered domestic flight recommendations with real-time pricing across India.',
            color: 'from-blue-400 to-sky-500',
        },
        {
            icon: <Cloud className="h-6 w-6" />,
            title: 'Weather Intelligence',
            description: 'Accurate Indian weather forecasts to help you pack right for any season.',
            color: 'from-sky-400 to-indigo-500',
        },
        {
            icon: <MapPin className="h-6 w-6" />,
            title: 'Local Guides',
            description: 'Discover hidden gems across India with personalized regional recommendations.',
    ...
    const partners = [
        { name: 'MakeMyTrip', url: 'https://www.makemytrip.com', logo: 'https://imgak.mmtcdn.com/pwa_v3/pwa_hotel_assets/favicon.ico' },
        { name: 'Goibibo', url: 'https://www.goibibo.com', logo: 'https://goibibo.ibcdn.com/images/ui/favicon.ico' },
        { name: 'IRCTC', url: 'https://www.irctc.co.in', logo: 'https://www.irctc.co.in/nget/assets/images/favicon.ico' },
        { name: 'Yatra', url: 'https://www.yatra.com', logo: 'https://www.yatra.com/favicon.ico' },
        { name: 'Cleartrip', url: 'https://www.cleartrip.com', logo: 'https://www.cleartrip.com/favicon.ico' },
        { name: 'EaseMyTrip', url: 'https://www.easemytrip.com', logo: 'https://www.easemytrip.com/favicon.ico' },
        { name: 'Ixigo', url: 'https://www.ixigo.com', logo: 'https://www.ixigo.com/favicon.ico' },
        { name: 'RedBus', url: 'https://www.redbus.in', logo: 'https://www.redbus.in/favicon.ico' }
    ]
                ...
                <div className="relative z-10 max-w-7xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-10">
                            From Kashmir to Kanyakumari — plan your perfect trip across India with AI assistance.
                            Flights, weather, local guides, all in one place.
                        </p>
                    ...
                    <div className="relative mt-16 max-w-5xl mx-auto">
                        ...
                        <div className="relative mx-auto w-64 sm:w-80">
                            <div className="relative bg-gray-900 rounded-[3rem] p-2 shadow-2xl">
                                <div className="bg-gray-900 rounded-[2.5rem] overflow-hidden">
                                    <img
                                        src={createGradientPlaceholder('#1e3a5f', '#3b82f6', 400, 600)}
                        ...
                        <div className="absolute left-0 sm:-left-8 top-1/4 animate-float">
                            <div className="bg-yellow-400 dark:bg-yellow-500 rounded-2xl p-4 shadow-xl">
                                <div className="text-xs font-medium text-yellow-800 mb-1">Engagement</div>
                                <div className="flex items-center gap-2">
                                    <TrendingUp className="h-6 w-6 text-yellow-800" />
                                    <span className="text-2xl font-bold text-yellow-900">40%</span>
                        ...
                        <div className="absolute -left-4 sm:-left-16 bottom-1/4 animate-float-delayed">
                            <div className="bg-white dark:bg-gray-800 rounded-2xl p-3 shadow-xl">
                                <img
                                    src={createGradientPlaceholder('#3b82f6', '#06b6d4', 100, 100)}
                            ...
                            <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-xl">
                                <div className="flex items-center gap-3">
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-500 dark:text-gray-400">destinations</div>
                                        <div className="text-xs text-gray-400 dark:text-gray-500">this week</div>
                                    </div>
                                    <img
                                        src={createGradientPlaceholder('#0ea5e9', '#06b6d4', 60, 80)}
                                        alt="Goa Beaches"
                        ...
                        <div className="absolute -right-4 sm:-right-12 bottom-1/4 animate-float-delayed">
                            <div className="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-xl">
                                <img
                                    src={createGradientPlaceholder('#22c55e', '#10b981', 150, 120)}
                                    alt="Munnar Tea Gardens"
                                    className="w-36 h-24 object-cover"
                                />
                                <div className="p-2 flex items-center justify-between">
                                    <span className="bg-blue-500 text-white text-xs px-2 py-0.5 rounded-full">1.5k</span>
                                    <div className="flex items-center gap-2">
                ...
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {features.map((feature, index) => (
                            ...
                            >
                                <div className={`inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br ${feature.color} rounded-2xl mb-6 text-white shadow-lg`}>
                                    {feature.icon}
                                </div>
            ...
            <section className="py-20 bg-gray-50 dark:bg-gray-800">
                <div className="max-w-7xl mx-auto px-4">
                            ...
                            >
                                ...
                                <div className="p-5">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-gray-500 dark:text-gray-400">{dest.reviews} reviews</span>
                                    </div>
                                </div>
                            </div>
                        ))}
                    ...
                    <div className="mt-8 flex flex-col items-center gap-4">
                        ...
                        >
                            {showAllDestinations ? 'Show Less' : `View All ${destinations.length} Destinations`}
                            {showAllDestinations ? (
                                <ChevronUp className="h-5 w-5" />
                            ) : (
                                <ChevronRight className="h-5 w-5" />
            ...
            <section className="py-24 bg-gradient-to-br from-blue-500 via-sky-500 to-indigo-500 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto">
                        Join thousands of Indian travelers who plan their perfect trips with TripAgent AI assistance.
                    </p>
                    <button
                        onClick={() => navigate('/search')}
