          ...
          <div className="flex items-center space-x-3">
            ...
            <SignedIn>
              <button
                ...
                className="hidden sm:flex items-center gap-1.5 px-5 py-2.5 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-full text-sm font-semibold hover:bg-gray-200 dark:hover:bg-gray-700 transition-all"
              >
                Sign Out
              </button>
            </SignedIn>
            ...
            <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 space-y-2">
              ...
              <SignedIn>
                <button
                  ...
                  className="w-full flex items-center justify-center space-x-2 px-4 py-3 rounded-lg text-sm font-medium bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700"
                >
                  <span>Sign Out</span>
                </button>
              </SignedIn>
